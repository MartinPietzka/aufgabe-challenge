...
//
//public class TransaktionImpl2 implements Transaktion {
...
//
//    public TransaktionImpl2(long id, Long senderKontonummer, Long empfaengerKontonummer, Long geldautomatNummer, BigDecimal betrag, Typ typ, LocalDateTime zeitpunkt) {
//
...
//        TransaktionImpl2 that = (TransaktionImpl2) o;
//        return id == that.id;
//    }
//
//    @Override
